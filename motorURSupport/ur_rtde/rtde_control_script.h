...
"              xd = q_from_input_float_registers(0)" + NEW_LINE  + 
"              contact_dir = pose_from_input_float_registers(6)" + NEW_LINE  + 
"              acc = read_input_float_reg(12)" + NEW_LINE  + 
"              while True:" + NEW_LINE  + 
"                 step_back = tool_contact(direction=contact_dir)" + NEW_LINE  + 
"                 if step_back <= 0:" + NEW_LINE  + 
"                    # Continue moving with specified speed vector" + NEW_LINE  + 
"                    speedl(xd, acc, t=get_steptime())" + NEW_LINE  + 
"                 else:" + NEW_LINE  + 
"                    # Contact detected!" + NEW_LINE  + 
"                    # Get q for when the contact was first seen" + NEW_LINE  + 
"                    q = get_actual_joint_positions_history(step_back)" + NEW_LINE  + 
"                    # Stop the movement" + NEW_LINE  + 
"                    stopl(3)" + NEW_LINE  + 
"                    # Move to the initial contact point" + NEW_LINE  + 
"                    movel(q)" + NEW_LINE  + 
"                    break" + NEW_LINE  + 
"                 end" + NEW_LINE  + 
"              end" + NEW_LINE  + 
...
"    #" + NEW_LINE  + 
"" + NEW_LINE  + 
"    textmsg("+QUOTATION+"RTDE Control Script Loaded (11.05.2021-15:29)"+QUOTATION+")" + NEW_LINE  + 
"" + NEW_LINE  + 
